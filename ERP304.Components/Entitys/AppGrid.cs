...
namespace ERP304.Components.Entitys {
    ...
    public class AppGrid : BaseControl {
        ...
        [Hint(Describe = "冻结列数", Type = FieldType.Number)]
        [XmlAttribute(AttributeName = "fastnesscount")]
        public string FastNessCount { get; set; }

        [Hint(Describe = "行头风格，0，不启用 1，序号列 2，复选框列", EnumType = typeof(SerialType), EnumValueType = EnumValueType.Value
    ...
    public class AppGridCell : AppGridCellBase {
        ...
        [Hint(Describe = "是否允许排序", Type = FieldType.Boolean)]
        ...
        /// </summary>
        [Hint(Describe = "控件类型", EnumType = typeof(AppGridCellType), EnumValueType = EnumValueType.Text
        ...
        [Hint(Describe = "是否保存", Type = FieldType.Boolean)]
